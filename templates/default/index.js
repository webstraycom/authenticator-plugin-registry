  ...
  const Content = () => {
    return React.createElement(
      ...
      React.createElement(
        ...
        'This is a simple example of a plugin, the code for which is only 40 lines! ',
        'Start developing your plugin by editing the ',
        React.createElement('strong', {}, 'plugins/{{ID}}/index.js '),
        'file.',
      ),
      React.createElement(
        Button,
        ...
        React.createElement('span', {}, 'Start Building'),
